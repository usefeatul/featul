...
export function UseCasesIndexHeroContent() {
  return (
    <div className="text-left" data-component="UseCasesIndexHeroContent">
      <h1 className="max-w-2xl font-heading text-[1.75rem] font-semibold leading-[1.2] tracking-tight text-white text-balance sm:text-4xl sm:leading-tight md:text-5xl">
        See how teams{" "}
