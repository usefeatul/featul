              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    <Icon className="mt-0.5 size-4 shrink-0 sm:size-5 text-primary" opacity={1} />
                    <div>
                      <h3 className="text-foreground text-balance text-base sm:text-lg font-medium">
                        {point.replace(/\.$/, "").trim()}
                      </h3>
                      <p className="text-accent mt-2 text-sm sm:text-base leading-7">
                        Compared with {alt.name}, this helps product teams move from raw feedback to shipped updates without juggling separate tools.
                      </p>
                    </div>
                  </div>
                </div>
