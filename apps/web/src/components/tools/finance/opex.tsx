...
export default function OpexRatioTool() {
  ...
  const ratio = React.useMemo(() => {
    const o = parseNumericInput(opex);
  ...
  return (
    <div>
      <div className="prose prose-sm sm:prose-base prose-zinc dark:prose-invert mt-6 tracking-wide">
        ...
        <p>
          Percentage of revenue consumed by operating expenses. Formula:{" "}
          <code>OpEx ratio = Operating expenses ÷ Revenue</code>. Use this
          calculator to understand how much of revenue goes to operating
          expenses. Enter total operating expenses and revenue to see the ratio
          as a percentage.
        </p>
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4">
        <Card>
          <CardHeader className="space-y-1 tracking-wide">
            ...
            <CardDescription>
              Enter operating expenses and revenue.
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 items-stretch">
              ...
              <div className="rounded-md  border p-3 text-center flex flex-col items-center justify-center min-h-[72px]">
                ...
                <div className="mt-1 font-mono text-base leading-tight text-foreground">
                  {parseNumericInput(opex).toLocaleString()}
                </div>
              </div>
              <div className="rounded-md  border p-3 text-center flex flex-col items-center justify-center min-h-[72px]">
                <div className="text-xs text-accent">Revenue</div>
                <div className="mt-1 font-mono text-base leading-tight text-foreground">
                  {parseNumericInput(revenue).toLocaleString()}
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <div className="prose prose-sm sm:prose-base prose-zinc dark:prose-invert mt-6">
          ...
          <p>
            The operating expense (OpEx) ratio shows the percentage of revenue
            consumed by operating expenses. It reflects efficiency of the cost
            structure relative to topline.
          </p>
          ...
          <h3>Example</h3>
          <p>
            Operating expenses {parseNumericInput(opex).toLocaleString()},
            Revenue {parseNumericInput(revenue).toLocaleString()} ⇒ OpEx ratio{" "}
            {formatPercent(ratio)}.
          </p>
          <h3>Optimization tips</h3>
          <ul>
            <li>
              Prioritize spend with measurable ROI; sunset underperforming
              initiatives.
            </li>
          ...
          <h3>FAQ</h3>
          <p>
            <strong>What is a good OpEx ratio?</strong> It varies by model and
            stage; trend direction and quality of spend matter most.
          </p>
          <p>
            <strong>Should COGS be included?</strong> No—OpEx excludes COGS; it
            covers operating expenses like R&D, S&M, and G&A.
          </p>
          <p>
            <strong>How does revenue scale affect the ratio?</strong> As revenue
            grows, the ratio should generally decline if the business is scaling
            efficiently.
          </p>
        </div>
      </div>
