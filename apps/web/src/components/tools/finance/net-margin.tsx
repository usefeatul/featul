...
export default function NetMarginTool() {
  ...
  const netMarginPct = React.useMemo(() => {
    ...
    const n = parseNumericInput(netIncome);
  ...
  return (
    <div>
      <div className="prose prose-sm sm:prose-base prose-zinc dark:prose-invert mt-6 tracking-wide">
        <h2>Net Margin</h2>
        <p>
          Net margin shows profitability after all expenses. Formula:{" "}
          <code>Net margin = Net income ÷ Revenue</code>. Use this calculator to
          measure bottom‑line profitability. Enter total revenue and net income
          to compute net margin and compare performance across periods.
        </p>
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 items-stretch">
              ...
              <div className="rounded-md  border p-3 text-center flex flex-col items-center justify-center min-h-[72px]">
                ...
                <div className="mt-1 font-mono text-base leading-tight text-foreground">
                  {formatUsd(parseNumericInput(netIncome))}
                </div>
              </div>
              <div className="rounded-md  border p-3 text-center flex flex-col items-center justify-center min-h-[72px]">
        ...
        <div className="prose prose-sm sm:prose-base prose-zinc dark:prose-invert mt-6">
          ...
          <p>
            Net margin measures the percent of revenue left after <em>all</em>{" "}
            expenses, including operating and non‑operating items. It reflects
          ...
          <ul>
            ...
            <li>
              Complements gross margin by accounting for the full cost
              structure.
            </li>
          ...
          <h3>Example</h3>
          <p>
            Revenue {formatUsd(parseNumericInput(revenue))}, Net income{" "}
            {formatUsd(parseNumericInput(netIncome))} ⇒ Net margin{" "}
            {formatPercent(netMarginPct)}.
          </p>
          ...
          <ul>
            ...
            <li>
              Improve gross margin (lower delivery costs) and optimize OpEx.
            </li>
            <li>Streamline go‑to‑market and automate manual processes.</li>
          </ul>
          <h3>FAQ</h3>
          <p>
            <strong>How does net margin differ from gross margin?</strong> Gross
            margin excludes operating expenses; net margin includes them.
          </p>
          <p>
            <strong>What’s a good net margin in SaaS?</strong> It varies widely
            by stage; low single digits in growth, higher in mature firms.
          </p>
          <p>
            <strong>Should I exclude one‑time costs?</strong> Track adjusted
            margin for comparability, but keep GAAP margin for completeness.
          </p>
        </div>
      </div>
    </div>
