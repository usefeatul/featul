...
export default function RevenuePerEmployeeTool() {
  ...
  const rpe = React.useMemo(() => {
    ...
    const e = parseNumericInput(employees);
    return e > 0 ? r / e : 0;
  }, [revenue, employees]);
  ...
  return (
    <div>
      <div className="prose prose-sm sm:prose-base prose-zinc dark:prose-invert mt-6 tracking-wide">
        ...
        <p>
          Revenue per employee indicates team efficiency. Formula:{" "}
          <code>RPE = Revenue ÷ Employees</code>. Use this calculator to
          benchmark revenue efficiency per teammate. Enter total revenue and the
          number of employees to understand productivity trends over time.
        </p>
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 items-end">
              ...
              <div className="space-y-1">
                ...
                <Input id="rpe" type="text" value={formatUsd(rpe)} readOnly />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="prose prose-sm sm:prose-base prose-zinc dark:prose-invert mt-6">
          ...
          <p>
            RPE measures how much revenue each team member generates on average.
            It’s a proxy for operational efficiency and can highlight
            productivity trends across stages of growth.
          </p>
          ...
          <p>
            RPE = Total revenue ÷ Number of employees. Use an average headcount
            for the period to avoid skew from rapid hiring.
          </p>
          <h3>Example</h3>
          <p>
            {formatUsd(parseNumericInput(revenue))} revenue and{" "}
            {parseNumericInput(employees).toLocaleString()} employees ⇒ RPE{" "}
            {formatUsd(rpe)}.
          </p>
          <h3>Caveats</h3>
          <ul>
          ...
          <h3>FAQ</h3>
          <p>
            <strong>What’s a good RPE?</strong> Varies widely; early SaaS may be
            $100k–$200k, mature companies higher.
          </p>
          <p>
            <strong>Should I use FTE or total headcount?</strong> Prefer average
            FTEs during the period for consistency.
          </p>
          <p>
            <strong>How often should I track RPE?</strong> Quarterly gives a
            balanced view across hiring cycles.
          </p>
        </div>
      </div>
    </div>
