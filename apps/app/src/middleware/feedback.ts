...
/** Resolve a custom host only via a DNS-verified workspaceDomain row. */
...
/** A verified custom host (not featul.com): rewrite public paths onto the matched workspace. */
