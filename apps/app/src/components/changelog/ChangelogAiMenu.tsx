...
interface ChangelogAiMenuProps {
...
export function ChangelogAiMenu({
  workspaceSlug,
  title,
  setTitle,
  setSummary,
  editorRef,
  setIsDirty,
}: ChangelogAiMenuProps) {
  const { setToolbarSlot } = useEditorHeaderActions();
  ...
  useEffect(() => {
    if (!dialogOpen || dialogTab !== "generate") return;
  ...
  const applyAiResult = useCallback(
    ...
    [editorRef, setIsDirty, setSummary, setTitle],
  );
...
export default ChangelogAiMenu;
