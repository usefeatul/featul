...
export default function FilterSummary({ className = "" }: { className?: string }) {
  ...
  const filterButtonClassName =
    "h-8 bg-card py-0 ring-offset-background"
    ...
    >
      {isVisible ? (
        <div
          ...
          className="pointer-events-auto flex max-w-full items-center gap-2 overflow-hidden rounded-xs bg-transparent px-1 py-0"
        >
