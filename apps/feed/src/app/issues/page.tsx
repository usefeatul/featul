...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createPageMetadata({ title: `Issues - ${name}`, description: `Public feedback and ideas for ${name}.`, path: "/issues", absoluteTitle: true, baseUrl })
}
...
export default async function IssuesPage() {
  ...
  return <BoardsView workspaceSlug={slug} workspaceName={name} defaultTab={"issues"} />
}
