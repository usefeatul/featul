...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createPageMetadata({ title: `Changelog - ${name}`, description: `Latest releases and updates from ${name}.`, path: "/changelog", absoluteTitle: true, baseUrl })
}
...
export default async function ChangelogPage() {
  ...
  return <BoardsView workspaceSlug={slug} workspaceName={name} defaultTab={"changelog"} />
}
