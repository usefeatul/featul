  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          overlayDialogClass,
          "data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-2 rounded-xl shadow-none transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
