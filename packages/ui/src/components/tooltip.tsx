		...
		<BaseTooltip.Portal>
			<BaseTooltip.Positioner sideOffset={sideOffset} side={side} align={align}>
				<BaseTooltip.Popup
					...
					className={cn(
						"bg-zinc-800 text-white dark:bg-white dark:text-black border border-border shadow-none outline-hidden animate-in fade-in-0 zoom-in-95 data-ending-style:opacity-0 data-starting-style:opacity-0 z-50 w-fit max-w-3xs whitespace-normal wrap-break-word leading-relaxed rounded-md px-2 py-1.5 text-sm",
						className,
					)}
					{...props}
				>
