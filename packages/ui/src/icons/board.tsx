    ...
    >
      ...
      <g fill="currentColor">
        ...
        <path
          ...
          fill="currentColor"
          className="transition-transform duration-150 ease-out origin-bottom-left group-hover:translate-x-0.5 group-hover:translate-y-0.5 group-hover:scale-95 group-active:translate-x-1 group-active:translate-y-1 group-active:scale-90"
        ></path>
        <path
