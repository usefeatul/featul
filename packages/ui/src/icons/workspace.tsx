...
export function WorkspaceCreateIcon({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M9.75 1.75H3.75C2.645 1.75 1.75 2.645 1.75 3.75V14.25C1.75 15.355 2.645 16.25 3.75 16.25H14.25C15.355 16.25 16.25 15.355 16.25 14.25V8.25" />
      <path d="M7.75 10.25C7.75 10.25 10.084 10.166 10.909 9.341L15.784 4.466C16.405 3.845 16.405 2.837 15.784 2.216C15.163 1.595 14.155 1.595 13.534 2.216L8.659 7.091C7.881 7.869 7.75 10.25 7.75 10.25Z" />
    </svg>
  );
}
