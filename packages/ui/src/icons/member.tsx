  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
        fillOpacity="0.4"
        className="transition-transform duration-200 ease-out origin-center group-hover:-translate-y-0.5 group-hover:scale-105 group-active:-translate-y-1 group-active:scale-110"
      />
    </svg>
  )
}
